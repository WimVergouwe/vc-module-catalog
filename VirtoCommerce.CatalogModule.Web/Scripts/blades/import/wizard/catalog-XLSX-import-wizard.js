...
.controller('virtoCommerce.catalogModule.catalogExcelimportWizardController', ['$scope', '$localStorage', 'platformWebApp.bladeNavigationService', 'FileUploader', 'virtoCommerce.catalogModule.xlsxImport', function ($scope, $localStorage, bladeNavigationService, FileUploader, importResource) {
    ...
    if (!$scope.uploader) {
        ...
        uploader.onSuccessItem = function (fileItem, asset, status, headers) {
            ...
            // Don't allow client to configure mapping for demo purposes.
            ...
            //blade.importConfiguration = new { eTag:"",propertyMaps: {}, propertyCsvColumns: {} }
            //blade.isLoading = false;
            //blade.canImport = true;
        };
    ...
    $scope.startImport = function () {
        ...
        importResource.run(exportInfo, function (notification) {
            var newBlade = {
                ...
                importConfiguration: blade.importConfiguration,
                controller: 'virtoCommerce.catalogModule.catalogExcelimportController',
